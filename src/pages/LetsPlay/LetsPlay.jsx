...
export default function LetsPlay() {
  return (
    ...
    >
      <div className='md:w-96 ms-11'>
        <h1 className='md:text-5xl text-3xl font-bold text-[#3E2723] my-5'>Test What You've Learned</h1>
      ...
      <img src={game} className='md:w-4/12 w-7/12 rounded-2xl' alt="" loading="lazy"/>
    </_motion.div>
  )
}
