...
export default function LetsPlay() {
  return (
    ...
    className='flex sm:flex-col-reverse sm:text-center py-5 md:text-left sm:items-center md:justify-around md:flex-row'>
      ...
      <button className='text-white bg-[#661414] font-semibold py-2 px-3 rounded-3xl cursor-progress hover:opacity-90'>Coming Soon  🚀 </button>
      </div>
<img src={game} className='w-4/12 rounded-2xl' alt="" />
    </_motion.div>
  )
}
